...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
       ...
       <h1 id="container_title">Ⅵ.2023 - 신청과정 >> <span style="color:#0404B4; font-weight:bold;">[ITQ] 한글, 워드 실무 과정</span></h1>
        <div class="container_wr">
            <div id="contents">
                <div id="tabMenu">
                  <input type="radio" id="tab1" name="tabs" checked />
                  <label for="tab1">[ITQ] 한글, 워드 실무 과정</label>
                  ...
                  <div id="notice" class="tabContent">
                    ...
                    <br>
					<span style="font-size:20px; font-weight:600;">[ITQ] 한글, 워드 실무 과정</span><br><br><br>
                  ...
                  <div id="gallery" class="tabContent">
                        ...
                        <object type="application/pdf" data="./pdf/20230725224110304.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="./pdf/20230725224110304.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
