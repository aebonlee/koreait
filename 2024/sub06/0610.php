...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
		...
		<h1 id="container_title">Ⅵ.2023 - 신청과정 >> <span style="color:#0404B4; font-weight:bold;">[Python, R] 파이썬과 R프로그래밍 활용 데이터분석과정 통합심사 신청정보</span></h1>
        <div class="container_wr">
            <div id="contents">
                <div id="tabMenu">
                  <input type="radio" id="tab1" name="tabs" checked />
                  <label for="tab1">[Python, R] 파이썬과 R프로그래밍 활용 데이터분석과정 통합심사 신청정보</label>
				  
                  <input type="radio" id="tab2" name="tabs" />
                  <label for="tab2">훈련교재</label>


                  <div id="notice" class="tabContent">
						  <object type="application/pdf" data="./pdf/20230725223732934.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="./pdf/20230725223732934.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
						  <param name="initZoom" value="fitToPage" />
						</object>
                  </div>
				  
                  <div id="gallery" class="tabContent">
						  <object type="application/pdf" data="./pdf/파이썬교재.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="./pdf/파이썬교재.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
						  <param name="initZoom" value="fitToPage" />
						</object>
                  </div>
