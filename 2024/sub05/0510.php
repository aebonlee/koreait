...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">Ⅴ.훈련생관리 >> <span style="color:#0404B4; font-weight:bold;">MOU 및 협력기관</span></h1>
        <div class="container_wr">
            <div id="contents">
                <div id="tabMenu">
                  <input type="radio" id="tab1" name="tabs" checked />
                  <label for="tab1">호서직업전문학교 협정서</label>
            
                  <div id="notice" class="tabContent">
                        <center>
                        <img src="./img/호서직업전문학교협정서.jpg" width="800px" height="auto">
						<br/><br/>
                        </center> 
                  </div>
				  <br><br><br><br>
