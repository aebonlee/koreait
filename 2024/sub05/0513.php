...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <div class="container_wr">
            <div id="contents">
			<span style="font-size:16px; color:black; font-weight:bold; line-height: 210%;">&nbsp;&nbsp;에듀컴퓨터교육학원 갤러리</span>
			<hr width="250px" style="border-style: solid; border-width:1px; border-color:#333366; line-height: 210%;"><br>
			<iframe src="http://www.educomputer.co.kr/bbs/board.php?bo_table=edu12" width="100%" height="1400px" frameborder='0' scrolling="auto" style="overflow-y:hidden"></iframe>
            </div>
		</div>
	</div>
</div>
