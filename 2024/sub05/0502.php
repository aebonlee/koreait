...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">Ⅴ.훈련생관리 >> <span style="color:#0404B4; font-weight:bold;">에듀컴퓨터교육학원 모집&홍보</span></h1>
        <div class="container_wr">
            <div id="contents">
                <div id="tabMenu">
                  <input type="radio" id="tab1" name="tabs" checked />
                  <label for="tab1">훈련생 모집& 홍보 매뉴얼</label>
                  <input type="radio" id="tab2" name="tabs" />
                  <label for="tab2">훈련생 모집&홍보 계획</label>
                  <input type="radio" id="tab3" name="tabs" />

                  <div id="notice" class="tabContent">

                        <object type="application/pdf" data="./pdf/모집홍보매뉴얼.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="./pdf/모집홍보매뉴얼.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
                  ...
                  <div id="gallery" class="tabContent">
                        ...
                        <object type="application/pdf" data="./pdf/모집홍보계획.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="./pdf/모집홍보계획.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
						  <param name="initZoom" value="fitToPage" />
						</object>
