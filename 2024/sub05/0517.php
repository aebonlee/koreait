...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">Ⅴ.훈련생관리 >> <span style="color:#0404B4; font-weight:bold;">고충처리 매뉴얼(고충처리 계획서, 중도탈락방지 계획서)</span></h1>
        <div class="container_wr">
            <div id="contents">
                <div id="tabMenu">
                  <input type="radio" id="tab1" name="tabs" checked />
                  <label for="tab1">수강생(훈련생) 상담 및 고충처리 계획서</label>
				  <input type="radio" id="tab2" name="tabs"/>
                  <label for="tab2">훈련생이 알아아할 12가지</label>
				  
            		<div id="gallery" class="tabContent">
                    <h2><a href="http://www.educomputer.co.kr/2023/sub05/hwp/에티켓.hwp" style="color:blue; font-weight:bold;">[한글파일 다운로드 : 에티켓.hwp]</a></h2><br>
                        <object type="application/pdf" data="./pdf/에티켓.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="./pdf/에티켓.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
						  <param name="initZoom" value="fitToPage" />
						</object>
                  </div>
				  
                  <div id="notice" class="tabContent">
                    <h2><a href="http://www.educomputer.co.kr/2023/sub05/hwp/면담및고충처리계획서.ppt" style="color:blue; font-weight:bold;">[한글파일 다운로드 : 면담및고충처리계획서.ppt]</a></h2><br>
                        <object type="application/pdf" data="./pdf/면담및고충처리계획서.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="./pdf/면담및고충처리계획서.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
						  <param name="initZoom" value="fitToPage" />
						</object>
                  </div>
				  <br><br><br><br>
