        ...
        <div class="container_wr">
            <div id="contents">
                <div id="tabMenu">
                  ...
                  <label for="tab1">중도탈락방지계획서</label>
            
                  <div id="notice" class="tabContent">
                    <h2><a href="http://www.educomputer.co.kr/2023/sub05/hwp/중도탈락방지계획서.ppt" style="color:blue; font-weight:bold;">[한글파일 다운로드 : 중도탈락방지계획서.ppt]</a></h2><br>
                        <object type="application/pdf" data="./pdf/중도탈락방지계획서.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="./pdf/중도탈락방지계획서.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
