...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">Ⅴ.훈련생관리 >> <span style="color:#0404B4; font-weight:bold;">에듀컴퓨터교육학원 교육체계도</span></h1>
        <div class="container_wr">
            <div id="contents">
                <div id="tabMenu">
                  <input type="radio" id="tab1" name="tabs" checked />
                  <label for="tab1">에듀컴퓨터교육학원 교육체계도</label>
                  <div id="notice" class="tabContent">
				  <br>
					<h2>※ 2023. 05월 기준 교육체계도 2가지 디자인, 내용은 향후 고용노동부 훈련을 하며 수정보완 예정.</h2>
                        <center>
                        <img src="./img/체계도.jpg" width="1600px" height="auto">
						<br>
						<img src="./img/체계도2.jpg" width="1600px" height="auto">
                        </center>
                  </div>
                </div>
            </div>
