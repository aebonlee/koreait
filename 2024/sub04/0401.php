...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">Ⅳ.훈련인프라 >> <span style="color:#0404B4; font-weight:bold;">안전관리 규정</span></h1>
        <div class="container_wr">
            <div id="contents">
                <div id="tabMenu">
                  <input type="radio" id="tab1" name="tabs" checked />
                  <label for="tab1">안전관리 규정</label>

                  <div id="notice" class="tabContent">
					<br>
                        <object type="application/pdf" data="./pdf/안전관리.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="./pdf/안전관리.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
