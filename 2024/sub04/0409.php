...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">훈련인프라</h1>
        <div class="container_wr">
            <div id="contents">
			<span style="font-size:16px; color:black; font-weight:bold; line-height: 210%;">&nbsp;&nbsp;에듀컴퓨터교육학원 훈련시설 현황</span>
			<hr width="280px" style="border-style: solid; border-width:1px; border-color:#333366; line-height: 210%;"><br>
			<iframe src="http://www.educomputer.co.kr/bbs/board.php?bo_table=edu04" width="100%" height="1200px" frameborder='0' scrolling="auto" style="overflow-y:hidden"></iframe>
            </div>
		</div>
	</div>
</div>
