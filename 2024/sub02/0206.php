...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">Ⅱ.훈련과정관리 >> <span style="color:#0404B4; font-weight:bold;">교사&학생 준수규정과 수행지침표</span></h1>
        <div class="container_wr">
            <div id="contents">
                <div id="tabMenu">
                  <input type="radio" id="tab1" name="tabs" checked />
                  <label for="tab1">교사&학생 준수규정</label>
                  <input type="radio" id="tab2" name="tabs" />
                  <label for="tab2">교사수행지침표</label>
            
                  <div id="notice" class="tabContent">
                    <h2><a href="http://www.educomputer.co.kr/2023/sub02/hwp/교사학생준수규정.hwp" style="color:blue; font-weight:bold;">[한글파일 다운로드 : 교사학생준수규정.hwp]</a></h2><br>
                        <object type="application/pdf" data="./pdf/교사학생준수규정.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="./pdf/교사학생준수규정.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
						  <param name="initZoom" value="fitToPage" />
						</object>
                  </div>
                   <div id="gallery" class="tabContent">
                    <h2><a href="http://www.educomputer.co.kr/2023/sub02/hwp/교사수행지침표.hwp" style="color:blue; font-weight:bold;">[한글파일 다운로드 : 교사수행지침표.hwp]</a></h2><br>
                        <object type="application/pdf" data="./pdf/교사수행지침표.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="./pdf/교사수행지침표.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
						  <param name="initZoom" value="fitToPage" />
						</object>
                  </div>
                </div>
