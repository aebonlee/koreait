...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">Ⅱ.훈련과정관리 >> <span style="color:#0404B4; font-weight:bold;">2023년 과정개발 내역</span></h1>
        <div class="container_wr">
            <div id="contents">
                <div id="tabMenu">
                  <input type="radio" id="tab1" name="tabs" checked />
                  <label for="tab1">2023년 재직자내일배움카드 10개 과정 입력내역</label>
            
                  <div id="notice" class="tabContent">
						<span style="font-weight:bold; font-size:12pt; line-height: 180%;">
							* 2023년 신규기관 인증평가 참여로 최대 10개 과정 입력 완료.
						</span>
						<img src="http://www.educomputer.co.kr/2023/sub02/img/class.JPG" width="1200px" height="auto"><br>
