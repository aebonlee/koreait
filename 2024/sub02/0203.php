...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">Ⅱ.훈련과정관리 >> <span style="color:#0404B4; font-weight:bold;">훈련수요조사</span></h1>
        <div class="container_wr">
            <div id="contents">
                <div id="tabMenu">
                  <input type="radio" id="tab1" name="tabs" checked />
                  <label for="tab1">2022년 지역 훈련수요조사</label>
                  <input type="radio" id="tab2" name="tabs" />
                  <label for="tab2">KRIVET 한국직업능력연구원 - 22년도 지역 훈련수요조사 요약자료</label>
            
                  <div id="notice" class="tabContent">
						<img src="http://www.educomputer.co.kr/2023/sub02/img/22수요조사.jpg" width="800px" height="auto"><br>
						<span style="font-weight:bold; font-size:12pt;">
							* 지역별 공식 수요조사 자료 참고. (요약자료 첨부)
						</span>
                  </div>
                  <div id="gallery" class="tabContent">
                        <object type="application/pdf" data="./pdf/202212_B12203_sum_kor.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="./pdf/202212_B12203_sum_kor.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
