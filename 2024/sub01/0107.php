...
<div id="wrapper" style="height=700px;">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">Ⅰ.기관경영 >> <span style="color:#0404B4; font-weight:bold;">특성화전략 (추진계획)</span></h1>
        <div class="container_wr" >
            <div id="contents">
                <div id="tabMenu">
                  <input type="radio" id="tab1" name="tabs" checked />
                  <label for="tab1">에듀컴퓨터교육학원 특성화전략 - 3개년</label>
                  <input type="radio" id="tab2" name="tabs" />

                  <div id="notice" class="tabContent">
                    <h2>에듀컴퓨터교육학원 3개년 특성화 전략, 추진계획</h2><br>
                    <div>
                        <center>
                        <img src="./img/중장기발전계획.JPG" width="900px" height="auto">
                        </center>
                    </div>
                  </div>
