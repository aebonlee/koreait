...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">Ⅰ.기관경영 >> <span style="color:#0404B4; font-weight:bold;">훈련운영절차서</span></h1>
        <div class="container_wr">
            <div id="contents">
                <div id="tabMenu">
                  <input type="radio" id="tab1" name="tabs" checked />
                  <label for="tab1">훈련운영절차서</label>
            
                  <div id="notice" class="tabContent">
                    <h2>에듀컴퓨터교육학원의 문서관리규정입니다. <a href="http://www.educomputer.co.kr/2023/sub01/hwp/훈련운영절차서.hwp" style="color:blue; font-weight:bold;">[한글파일 다운로드 : 훈련운영절차서.hwp (2023.04월 기준)]</a></h2><br>
                        <object type="application/pdf" data="./pdf/훈련운영절차서.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="./pdf/훈련운영절차서.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
