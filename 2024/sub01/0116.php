...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">Ⅰ.기관경영 >> <span style="color:#0404B4; font-weight:bold;">부정훈련예방자료</span></h1>
        <div class="container_wr">
            <div id="contents">
			<span style="font-size:16px; color:black; font-weight:bold; line-height: 210%;">&nbsp;&nbsp;에듀컴퓨터교육학원 부정훈련예방자료</span>
			<hr width="306px" style="border-style: solid; border-width:1px; border-color:#333366; line-height: 210%;"><br>
			<br>
					...
					<td width="200px" align=center style="border-style: solid; border-width:1px; border-color:#333366; color:black; font-weight:bold; font-size:12pt;">2023.05.29</td>
					<td width="200px" align=center style="border-style: solid; border-width:1px; border-color:#333366; color:black; font-weight:bold; font-size:12pt;">2023.05.29</td>
					<td width="200px" align=center style="border-style: solid; border-width:1px; border-color:#333366; color:black; font-weight:bold; font-size:12pt;">2023.05.29</td>
				...
				<br><br>
			<iframe src="http://www.educomputer.co.kr/bbs/board.php?bo_table=edu03" width="100%" height="1000px" frameborder='0' scrolling="auto" style="overflow-y:hidden"></iframe>
            </div>
		</div>
	</div>
</div>
