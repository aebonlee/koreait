...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">Ⅰ.기관경영 >> <span style="color:#0404B4; font-weight:bold;">기관운영규정(경영원칙)</span></h1>
						<br>
					...
					<td width="200px" align=center style="border-style: solid; border-width:1px; border-color:#333366; color:black; font-weight:bold; font-size:12pt;">2023.05.01</td>
					<td width="200px" align=center style="border-style: solid; border-width:1px; border-color:#333366; color:black; font-weight:bold; font-size:12pt;">2023.05.01</td>
					<td width="200px" align=center style="border-style: solid; border-width:1px; border-color:#333366; color:black; font-weight:bold; font-size:12pt;">2023.05.01</td>
        ...
        <div class="container_wr">
            <div id="contents">
                <div id="tabMenu">
                  ...
                  <label for="tab1">에듀컴퓨터교육학원 기관운영규정</label>
				  
                  <input type="radio" id="tab2" name="tabs" />
				  <label for="tab2">에듀컴퓨터교육학원 경영원칙</label>

                  <div id="notice" class="tabContent">
                    <h2>학원 학칙과 인사규정, 시설장비규정을 모두 담고 있는 에듀컴퓨터교육학원의 기관운영규정입니다. <a href="http://www.educomputer.co.kr/2023/sub01/hwp/1.1.1 기관운영규정.hwp" style="color:blue; font-weight:bold;">[한글파일 다운로드 : 1.1.1 기관운영규정.hwp (2023.04월 기준)]</a></h2><br>
					
		                <object type="application/pdf" data="./pdf/기관운영규정.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="./pdf/기관운영규정.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
