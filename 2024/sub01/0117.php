...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">Ⅰ.기관경영 >> <span style="color:#0404B4; font-weight:bold;">비상연락망</span></h1>
        <div class="container_wr">
            <div id="contents">
                <div id="tabMenu">
                  <input type="radio" id="tab1" name="tabs" checked />
                  <label for="tab1">에듀컴퓨터교육학원 주변 비상연락망</label>

                  <div id="notice" class="tabContent">

                        <object type="application/pdf" data="./pdf/비상연락망.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="./pdf/비상연락망.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
