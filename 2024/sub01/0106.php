...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">Ⅰ.기관경영 >> <span style="color:#0404B4; font-weight:bold;">장기/중기/단기계획</span></h1>
                ...
                <div id="tabMenu">
                  ...
                  <div id="notice" class="tabContent">
                    ...
                    <div class="local_desc02 local_desc">
                        <center>
                        <img src="./img/학원운영등록증_에듀컴퓨터교육학원.jpg" width="800px" height="1280px">
                        </center>
                    </div>
                  </div>
                  <div id="gallery" class="tabContent">
                    <h2>공지사항 내용입니다.</h2>
                    <div class="local_desc02 local_desc">
                        <object type="application/pdf" data="./pdf/2023.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="./pdf/2023.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
