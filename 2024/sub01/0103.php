...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">Ⅰ.기관경영 >> <span style="color:#0404B4; font-weight:bold;">대표훈련과정소개</span></h1>
		<div class="container_wr">
            <div id="contents">
                    
                        <object type="application/pdf" data="./pdf/(집체신규기관용) 에듀컴퓨터교육학원_대표훈련과정 개요서.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="./pdf/(집체신규기관용) 에듀컴퓨터교육학원_대표훈련과정 개요서.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
