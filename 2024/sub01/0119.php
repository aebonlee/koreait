...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">Ⅰ.기관경영 >> <span style="color:#0404B4; font-weight:bold;">정보보안(개인정보) 규정 및 관리 매뉴얼</span></h1>
        <div class="container_wr">
            <div id="contents">
                <div id="tabMenu">
                  <input type="radio" id="tab1" name="tabs" checked />
                  <label for="tab1">정보보안(개인정보)규정</label>
                  <input type="radio" id="tab2" name="tabs" />
                  <label for="tab2">정보보안(개인정보) 및 관리 매뉴얼</label>

                  <div id="notice" class="tabContent">
                    <h2>에듀컴퓨터교육학원의 정보보안(개인정보) 규정입니다. <a href="http://www.educomputer.co.kr/2023/sub01/hwp/정보보안규정.hwp" style="color:blue; font-weight:bold;">[한글파일 다운로드 : 정보보안규정.hwp (2023.04월 기준)]</a></h2><br>
                    <div>

                        <object type="application/pdf" data="./pdf/정보보안규정.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="./pdf/정보보안규정.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
				  ...
				  <div id="gallery" class="tabContent">
                     <h2>에듀컴퓨터교육학원의 정보보안(개인정보) 및 관리 매뉴얼입니다. <a href="http://www.educomputer.co.kr/2023/sub01/hwp/정보보안및관리매뉴얼.hwp" style="color:blue; font-weight:bold;">[한글파일 다운로드 : 정보보안및관리매뉴얼.hwp (2023.04월 기준)]</a></h2><br>
                    <div>

                        <object type="application/pdf" data="./pdf/정보보안및관리매뉴얼.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="./pdf/정보보안및관리매뉴얼.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
						  <param name="initZoom" value="fitToPage" />
						</object>
                    </div>					
				  </div>
