...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">Ⅰ.기관경영 >> <span style="color:#0404B4; font-weight:bold;"> 2023 자체평가보고서</span></h1>
		<div class="container_wr">
            <div id="contents">
                    
                        <object type="application/pdf" data="./pdf/(집체신규기관용) 2023년_202004280_에듀컴퓨터교육학원_자체평가보고서.pdf#toolbar=1&navpane=0" width="100%" height="1400px">
						  <embed src="./pdf/(집체신규기관용) 2023년_202004280_에듀컴퓨터교육학원_자체평가보고서.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1400px" />
