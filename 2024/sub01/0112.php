...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">Ⅰ.기관경영 >> <span style="color:#0404B4; font-weight:bold;">정보보안매뉴얼/지침</span></h1>
        <div class="container_wr">
            <div id="contents">
			<span style="font-size:16px; color:black; font-weight:bold; line-height: 210%;">&nbsp;&nbsp;에듀컴퓨터교육학원 정보보안매뉴얼/지침</span>
			...
			<br>
				...
				<br><br>
			<iframe src="http://www.educomputer.co.kr/bbs/board.php?bo_table=edu02" width="100%" height="1000px" frameborder='0' scrolling="auto" style="overflow-y:hidden"></iframe>
            </div>
		</div>
	</div>
</div>
