...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
         ...
         <h1 id="container_title">Ⅰ.기관경영 >> <span style="color:#0404B4; font-weight:bold;">회의록 (주간/월간)</span></h1>
        <div class="container_wr">
            <div id="contents">
			<span style="font-size:16px; color:black; font-weight:bold; line-height: 210%;">&nbsp;&nbsp;에듀컴퓨터교육학원 회의록</span>
			<hr width="230px" style="border-style: solid; border-width:1px; border-color:#333366; line-height: 210%;"><br>
			<iframe src="http://www.educomputer.co.kr/bbs/board.php?bo_table=edu01" width="100%" height="1400px" frameborder='0' scrolling="auto" style="overflow-y:hidden"></iframe>
            </div>
		</div>
	</div>
</div>
