        ...
        <div class="container_wr">
            <div id="contents">
                <div id="tabMenu">
                  ...
                  <label for="tab1">고용보험가입증명서</label>

                  <div id="notice" class="tabContent">
					<br>
                        <object type="application/pdf" data="../sub01/pdf/4대보험.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="../sub01/pdf/4대보험.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
