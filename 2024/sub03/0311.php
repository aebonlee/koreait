...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">Ⅲ.훈련전담인력 >> <span style="color:#0404B4; font-weight:bold;">고용보험가입증명서</span></h1>
        <div class="container_wr">
            <div id="contents">
                <div id="tabMenu">
                  <input type="radio" id="tab1" name="tabs" checked />
                  <label for="tab1">에듀컴퓨터교육학원 학원운영등록증</label>
				  <input type="radio" id="tab2" name="tabs" />
                  <label for="tab2">에듀컴퓨터교육학원 사업자등록증명서</label>
				  <input type="radio" id="tab3" name="tabs" />
                  <label for="tab3">에듀컴퓨터교육학원 교육청경력증명서</label>

                  <div id="notice" class="tabContent">
					<br>
                        <center>
                        <img src="../sub01/img/학원운영등록증_에듀컴퓨터교육학원.jpg" width="800px" height="auto">
                        </center>
                  </div>
                  <div id="gallery" class="tabContent">
					<br>					
                        <center>
                        <img src="../sub01/img/사업자등록증명서_에듀컴퓨터교육학원.jpg" width="800px" height="auto">
                        </center>
				  ...
				  <div id="gallery2" class="tabContent">
					<br>					
                        <center>
                        <img src="./img/교육청경력증명서.jpg" width="800px" height="auto">
                        </center>
