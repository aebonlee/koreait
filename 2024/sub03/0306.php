...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title">Ⅲ.훈련전담인력 >> <span style="color:#0404B4; font-weight:bold;">직무평가 지침/계획/평가표</span></h1>
        <div class="container_wr">
            <div id="contents">
                <div id="tabMenu">
                  <input type="radio" id="tab1" name="tabs" checked />
                  <label for="tab1">직무평가 지침/계획/평가표</label>

                  <div id="notice" class="tabContent">
					<br>
                        <object type="application/pdf" data="./pdf/test.pdf#toolbar=1&navpane=0" width="100%" height="1280px">
						  <embed src="./pdf/test.pdf#toolbar=1&navpane=0" type="application/pdf" width="100%" height="1280px" />
